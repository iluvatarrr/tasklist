...
public class TaskController {
    ...
    public TaskDto updateTask(@Validated(OnUpdate.class) @RequestBody @Argument(name = "dto") TaskDto taskDto) {
    ...
    public TaskDto getById(@PathVariable("id") @Argument Long id) {
